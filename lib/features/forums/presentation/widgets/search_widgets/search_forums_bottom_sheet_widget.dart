...
class SearchBottomSheetCommentsWidget extends StatelessWidget {
  const SearchBottomSheetCommentsWidget({
    Key? key,
    required this.index,
  }) : super(key: key);
              ...
              children: [
                ...
                Expanded(
                  child: ListView.separated(
                    itemCount: state
                        .searchForumsEntitie[index].forumsCommentsEtitie.length,
                    itemBuilder: (context, commentIndex) {
                      return ListTile(
                        ...
                        title: Text(
                          state.searchForumsEntitie[index]
