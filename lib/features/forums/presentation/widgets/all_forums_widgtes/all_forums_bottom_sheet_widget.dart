...
class AllForumsBottomSheetCommentsWidget extends StatelessWidget {
  const AllForumsBottomSheetCommentsWidget({
    Key? key,
    required this.index,
  }) : super(key: key);
              ...
              children: [
                ...
                Expanded(
                  child: ListView.separated(
                    itemCount: state
                        .allForumsEntitie[index].forumsCommentsEtitie.length,
