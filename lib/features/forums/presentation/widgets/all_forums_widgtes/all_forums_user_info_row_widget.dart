...
class AllForumsDesignPostUserInfoRow extends StatelessWidget {
  const AllForumsDesignPostUserInfoRow({
    Key? key,
    required this.index,
  }) : super(key: key);
  final int index;
        ...
        return Row(
          children: [
            CachedNetworkImage(
                ...
                imageUrl:
                    state.allForumsEntitie[index].forumsUserEntitie.imageUrl,
